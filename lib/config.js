...
var definitions = {
  ...
  'version': {
    alias: 'v',
    type: 'boolean',
    description: 'Display Titanium Debugger\'s version.',
    usage: '--version',
    _isNodeInspectorOption: true,
    _isNodeDebugOption: true,
    default: false
  ...
  'web-port': {
    alias: ['port', 'p'],
    type: 'string',
    description: 'Port to listen on for Titanium Debugger\'s web interface.',
    usage: {
      '--web-port 8081': '',
      '-p 8081': ''
    },
  ...
  'web-host': {
    type: 'string',
    description: 'Host to listen on for Titanium Debugger\'s web interface.',
    usage: {
      '--web-host 127.0.0.1': '',
...
Config.prototype.showVersion = function() {
  console.log('Titanium Debugger v' + require('../package.json').version);
};
